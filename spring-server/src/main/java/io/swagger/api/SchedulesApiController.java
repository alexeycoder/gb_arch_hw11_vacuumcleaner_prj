...
public class SchedulesApiController implements SchedulesApi {
    ...
    public ResponseEntity<Schedule> findScheduleById(@Parameter(in = ParameterIn.PATH, description = "Идентификатор расписания", required=true, schema=@Schema()) @PathVariable("scheduleId") Object scheduleId
) {
    ...
    public ResponseEntity<Void> updateSchedule(@Parameter(in = ParameterIn.PATH, description = "Идентификатор расписания", required=true, schema=@Schema()) @PathVariable("scheduleId") Object scheduleId
