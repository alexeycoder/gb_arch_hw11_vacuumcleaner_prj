...
public class Device   {
  ...
  public Device deviceId(Object deviceId) { 
  ...
  @Override
  public int hashCode() {
    return Objects.hash(deviceId, typeId, name, modelId, serialNum, firmwareVersion, connectionId);
  }
